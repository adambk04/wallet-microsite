...
export class SecurityTipsMarkupResponsive extends React.Component {
	render() {

		return(
			<div className="font--dark-grey desktop--hide" style={{paddingBottom: "10em"}}>
				<section className="section--container overflow--hidden flex--centralise padding-top--3em padding-bottom--3em">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-mobile-device-password.png" className="resize-image--300"/>
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-dont-use-same-password-twice.png" className="resize-image--300" />
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-install-app-from-trusted-sources.png" className="resize-image--300"/>
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-only-connect-to-trusted-networks.png" className="resize-image--300" />
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-keep-your-mobile-device-updated.png" className="resize-image--220" />
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-keep-your-personal-information-private.png" className="resize-image--300" />
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-keep-login-credentials-secure.png" className="resize-image--220" />
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-call-customer-service.png"/>
					</div>
				</section>
				<section className="section--container overflow--hidden flex--centralise  padding-top--3em padding-bottom--3em">
					<div className="column--left column--left--fluid display--inline-block">
					...
					<div className="column--right column--right--fluid display--inline-block">
							<img src="images/securitytips-image-verification.png"/>
					</div>
				</section>
			</div>
		);
