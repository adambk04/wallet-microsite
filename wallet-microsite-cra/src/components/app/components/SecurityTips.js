...
import { SecurityTipsMarkup } from "./SecurityTipsMarkup";
import { SecurityTipsMarkupResponsive } from "./SecurityTipsMarkupResponsive";
...
export class SecurityTips extends React.Component {
			...
			<div className={"container height--100 " + this.state.section.backgroundColor}>
				...
				<div className="sections--container padding-top--2em linear-gradient" style={marginOffset}>
					<div className="text-align--center">
						<h1 className={this.state.section.headerFontColor}>Security Tips</h1>
					</div>
					<SecurityTipsMarkup/>
					<SecurityTipsMarkupResponsive/>
				</div>
